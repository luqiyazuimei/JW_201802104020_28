...
let SchoolService = class SchoolService {
    constructor(http) {
        this.http = http;
        this.collegeUrl = '../'; //sevlet的相对路径，
    }
    /** GET colleges from the server */
    getColleges() {
        return this.http.get(this.collegeUrl + 'school.ctl')
    ...
    getCollege(id) {
        const url = this.collegeUrl + 'school.ctl?id=' + id;
    ...
    addCollege(college) {
        return this.http.post(this.collegeUrl + 'school.ctl', college, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('addCollege')));
    }
    /** DELETE: delete the college from the server */
    deleteCollege(college) {
        const id = typeof college === 'number' ? college : college.id;
        return this.http.delete(this.collegeUrl + 'school.ctl?id=' + id, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('deleteCollege')));
    }
    /** PUT: update the hero on the server */
    updateCollege(college) {
        return this.http.put(this.collegeUrl + 'school.ctl', college, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('updateCollege')));
    }
    /**
